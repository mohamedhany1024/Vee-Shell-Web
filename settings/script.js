let promptSound = new Audio('../shell/sounds/prompt_generic.mp3');
...
function retriveWallpaper() {
    ...
    if (retrivedData == "wall1") {
        ...
        bastard.style.backgroundImage = ("url('../shell/wallpapers/kde1.png')")
        console.log("bg set");
    }

    if (retrivedData == "wall2") {
        let bastard = document.getElementById("bag");
        bastard.style.backgroundImage = ("url('../shell/wallpapers/wall2.jpeg')")
        console.log("bg2 set");
    }
